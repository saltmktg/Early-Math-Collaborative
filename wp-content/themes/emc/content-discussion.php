	...
	<header class="entry-header">
		...
		<a href="<?php the_permalink(); ?>" alt="<?php the_title(); ?>">
			<div class="feat-post-img">
				...
				<img width="640" height="360" src='http://emc.staging.wpengine.com/wp-content/themes/emc/img/bg-erikson-generic.jpg' alt="<?php the_title(); ?>" />
				<?php } ?>
