	...
	<table class="tribe-events-calendar">
		...
		<tr>
			...
			<td class="<?php tribe_events_the_month_day_classes() ?>"
				...
				<div class="tribe-events-addnew">
					<form action="<?php echo get_site_url(); ?>/events/community/add/" method="post">
						<input type="hidden" name="prepopulate_event_date" value="<?php echo esc_attr( isset( $daydata['daynum'] ) ? $daydata['date'] : '' ); ?>" />
