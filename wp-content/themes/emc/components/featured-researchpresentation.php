<?php 
	...
	$publications = get_posts(array(
		...
		'meta_query' => array(
			array(
				'key' => 'featured_in_authors_profile_pages', // name of custom field
...
<h1><a href="/research/research-presentations/" alt="View all Research Presentations" title="View all Research Presentations">Research Presentations</a></h1>
...
<a href="http://earlymath.erikson.edu/research/research-presentations/?u=<?php echo $curauth->ID; ?>">
	<div class="learnmore">
